...
if (isset($_POST['button'])) {
    ...
    if ($apassword != $cpassword) {
        ...
        $check = mysqli_query($con, "SELECT * from uclog WHERE ucname='$cname'");
        $count = mysqli_num_rows($check);
        if ($count > 0) {
            echo "<script>alert('User already Exists'); location.href='register.php';</script>";
            $fmsg = "User already Exists";
        } else {
            $query = mysqli_query($con, "INSERT INTO uclog (id,ucname,pass) VALUES ('$uid','$cname','$apassword')");
            if ($query) {
                ...
                <div style="text-align: center; font-size:30px;">
                    ...
                    <div class="d-flex justify-content-center form_container">
                        ...
                        <div class="input-group mb-3">
                                ...
                                <input type="text" required name="uid" class="form-control input_user" value="" placeholder="Uc ID">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="fa fa-user"></i></span>
                                </div>
                                <input type="text" required name="cname" class="form-control input_user" value="" placeholder="UC Name">
                            </div>
